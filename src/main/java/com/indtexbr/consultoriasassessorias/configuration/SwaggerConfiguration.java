package com.indtexbr.consultoriasassessorias.configuration;
...
public class SwaggerConfiguration implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(new ApiInfo("Consultorias e Assessorias", "Microsserviço para acesso ao módulo de Consultorias e Assessorias", "1.0", "urn:tos",
                        new Contact("Carlos Schredinger","","carlinhos@indtexbr.com.br"), "Apache 2.0", "http://www.apache.org/licenses/LICENSE-2.0", new ArrayList<VendorExtension>()))
                .tags(new Tag("Parceiro", "Acesso \u00e0s Consultorias e Assessorias"),
                        new Tag("Contrato", "Acesso aos contratos relacionados \u00e0s \u00e0s Consultorias ou Assessorias"))
