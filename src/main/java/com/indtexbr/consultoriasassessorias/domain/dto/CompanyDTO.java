...
public class CompanyDTO {
    ...
    @NotNull
    @ApiModelProperty(example = "30.281.367/0001-91", readOnly = true)
    private String document;

    @Digits(integer = 10, fraction = 2)
    @ApiModelProperty(example = "Charles Fix", readOnly = true)
    private String name;

    @ApiModelProperty(example = "+5511950207776", readOnly = true)
    private String contactPhone;

    @ApiModelProperty(example = "contato@charlesfix.com", readOnly = true)
